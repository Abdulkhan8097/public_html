...
<body>
    ...
    <div class="padding-15">
        ...
        <div class="login-box">
            ...
            <!-- password form -->
            <form action="<?php echo ADMIN_OTP_VERIFICATION_DETAILS_SUBMIT_URL; ?>" method="post"
                ...
                <fieldset>
                    ...
                    <label class="input">
                        ...
                        <input type="text" name="email_otp_verification" id="email_otp_verification" minlength="6"
                            maxlength="6" pattern="[0-9]+" title="Please Enter Otp" placeholder="Enter Otp..."
                            required="required">
