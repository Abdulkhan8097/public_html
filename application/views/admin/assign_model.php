                      ...
                      <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                           <div class="form-group">
                              ...
                              <select name="state_id" class=" select2 form-control" id="state" onchange="createCityDLL();">
                        ...
                        <div class="col-md-3">
                           <div class="form-group">
                              ...
                              <select name="model_id" class=" select2 form-control" id="article">
               ...
               <form action="" method="POST">
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              <label for="city">Select Categories<span class="required"></span></label>
                              <select name="model_id" class="form-control" id="model" onchange="create();">
                                 <option selected disabled>--Select Categories--</option>
                                 <?php if(isset($category) && !empty($category)){
                                    foreach ($category as $key => $value) {
                                        ?>
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              <label for="city">Total Count<span class="required"></span></label>
                              <select name="" class="form-control" id="articles">
                                 <option selected disabled><----Total Count----></option>
