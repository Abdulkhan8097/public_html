            ...
            <div class="panel-heading">
                ...
                <ul class="options pull-right list-inline">
                  ...
                  <!--   <li>
                    ...
                    <li>
                        <a href="<?php echo base_url('admin/Product/get_excel_report/'); ?>" class="btn btn-primary btn-sm ">
                            Export To Excel
                        </a>
                    </li>
                     <li>
                      ...
                      <li>
                         <form action="<?php echo base_url('admin/Product/import'); ?>" method="POST" enctype="multipart/form-data">
                            <div class="upload-btn-wrapper ">
                              <button class="btn btn-primary btn-sm"><i class="fa fa-wrench"></i>Update Product</button>
                        ...
                        <thead>
                            <tr>
                                ...
                                <td scope="col" class="text-center">MRP</td>
                                 <td scope="col" class="text-center">Category Name</td>
