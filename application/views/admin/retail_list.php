...
<section id="middle">
   <header id="page-header">
      ...
      <ol class="breadcrumb">
         ...
         <li class="active">Related Product List</li>
      </ol>
   </header>
      ...
      <div id="panel-1" class="panel panel-default">
         <div class="panel-heading">
            <span class="title elipsis">
               <strong>ADD RELATED PRODUCT</strong>
                     ...
                     <div class="row">
                        <div class="form-group">
                           <div class="col-md-4">
                              ...
                              <select name="part_no" class=" select2 form-control" id="part_no">
                           ...
                           <div class="form-group">
                              <div class="col-md-4">
                                 ...
                                 <select name="part_no1" class=" select2 form-control" id="part_no1">
                                    <option selected disabled>--Select Child Part No--</option>
                                    <?php if(isset($product) && !empty($product)){
                                       foreach ($product as $key => $value) {
                                           ?>
                                    <option value="<?php echo $value['product_id']; ?>">
                     ...
                     <div class="card mb-3 catag">
                        <div class="card-body">
                           <div class="table-responsive">
                              <table class="table table-bordered text-center" width="100%" cellspacing="0" id="tabtag">
                                 <thead>
                                    <tr>
                                       <th class="text-center">Part No</th>
                                       <th class="text-center">Child Part No.</th>
...
<div class="panel-heading">
<span class="title elipsis">
<strong>Related Product List</strong>
<!-- <small class="size-12 weight-300 text-mutted hidden-xs">2015</small> -->
</span>
<ul class="options pull-right list-inline">
<li>
         ...
         $.ajax({
           ...
           success:function(data){
             ...
             $("#load-table").append("<tr>" +
               "<td>" + part_no +"<input type='hidden' name='part_no[]' value='"+ part_no + "'></td>" +
               "<td>" + part_no1 +"<input type='hidden' name='part_no1[]' value='"+ part_no1 + "'></td>" +
               // "<td>"+ "<a href='#' id='delete' class='btn btn-danger btn-sm'><i class='fa fa-trash' style='padding-right: 0;'></i></a>" +"</td>" +
               "</tr>"
