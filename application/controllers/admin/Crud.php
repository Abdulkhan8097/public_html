<?php  
 ...
 class Crud extends CI_Controller {  
      ...
      function fetch_user(){  
           $this->load->model("admin/Crudd_model");  
           $fetch_data = $this->Crudd_model->make_datatables();  
           $data = array();  
           ...
           $output = array(  
                ...
                "recordsTotal"          =>      $this->Crudd_model->get_all_data(),  
                "recordsFiltered"     =>     $this->Crudd_model->get_filtered_data(),  
                "data"                    =>     $data  
           );  
      ...
      function user_action(){  
           ...
           {  
                ...
                $this->load->model('admin/Crudd_model');  
                $this->Crudd_model->insert_crud($insert_data);  
                echo 'Data Inserted';  
           }  
           ...
           {  
                ...
                $this->load->model('admin/Crudd_model');  
                $this->Crudd_model->update_crud($this->input->post("user_id"), $updated_data);  
                echo 'Data Updated';  
           }  
      }  
      ...
      {  
           $output = array();  
           $this->load->model("admin/Crudd_model");  
           $data = $this->Crudd_model->fetch_single_user($_POST["user_id"]);  
           foreach($data as $row)  
           {  
