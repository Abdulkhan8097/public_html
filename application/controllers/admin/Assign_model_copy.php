...
class AssignModel extends CI_Controller
{
	 ...
	 public function getCity()
    {
        ...
        if (isset($_POST['state_id']) && !empty($_POST['state_id'])) {
            ...
            if (isset($numbers) && !empty($numbers)) {
                $appends .= "<option disabled selected value=''>-- Total Count --</option>";
             
                    $appends .= "<option  value=" . $value['product_id'] . ">" . $numbers . "</option>";
            } else {
	...
	public function count()
    {
      $append = '';
            ...
            $admin = $this->db->get('model_product')->result_array();
            print_r($admin);
            exit;
            $html = '';
